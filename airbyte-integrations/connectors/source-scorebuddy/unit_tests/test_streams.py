...
import pytest
from source_scorebuddy.source import ScorebuddyStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ScorebuddyStream, "path", "v0/example_endpoint")
    mocker.patch.object(ScorebuddyStream, "primary_key", "test_primary_key")
    mocker.patch.object(ScorebuddyStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = ScorebuddyStream()
